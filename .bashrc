...
alias tela='xrandr --output DP1 --auto --right-of eDP1'
alias hdmi='xrandr --output HDMI-1 --auto --right-of eDP1'
...
# Editar mirror.list
alias lists='sudo vim /etc/pacman.d/mirrorlist'

alias unimatrix='python ~/Scripts/unimatrix/unimatrix.py -n -s 96 -l o'
...
# Tecla pipe substituindo a tecla Pause Break
xmodmap -e "keycode 127 = bar"
...
export PATH="$PATH:/home/tiagofloyd/.gem/ruby/2.6.0/bin"
